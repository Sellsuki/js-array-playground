let examples = [
  ...
  {
    title: 'Array.slice()',
    content: 'เป็นการสร้าง array ขึ้นมาใหม่โดย return ค่าใน array เดิม โดยการกำหนด parameter 2 ตัว คือตำแหน่งเริ่มต้นกับตำแหน่งสุดท้าย (ตำแหน่งสุดท้ายจะไม่ถูก return) เช่น ต้องการดึงค่าในตำแหน่งที่ 0 ถึง ตำแหน่งที่ 3',
