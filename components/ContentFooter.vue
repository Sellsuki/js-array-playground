<template>
  <center class="is-small">
    ...
    &nbsp;&nbsp;
    <a class="github-button" href="https://github.com/Sellsuki/js-array-playground/fork" data-icon="octicon-repo-forked" data-style="mega" data-count-href="/Sellsuki/js-array-playground/network" data-count-api="/repos/Sellsuki/js-array-playground#forks_count" data-count-aria-label="# forks on GitHub" aria-label="Fork Sellsuki/js-array-playground on GitHub">Fork</a>
    <br><br>
    Made with {{ footerEmoji }} and <a href="http://vuejs.org" target="_blank"><img class="vue-icon" src="https://vuejs.org/images/logo.png" alt="vue.js"/></a>.
    <br>
    <br>
